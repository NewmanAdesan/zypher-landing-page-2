...
export function Navbar() {
    ...
    return (
        <>
            <nav className="fixed top-0 w-[92%] overflow-hidden xs2:w-full z-50 bg-background/80 backdrop-blur-md border-b border-border transition-colors duration-300">
